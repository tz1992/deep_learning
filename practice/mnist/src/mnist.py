...
def main():
    ...
    data_train = DealDataSet('data/', "train-images-idx3-ubyte.gz", "train-labels-idx1-ubyte.gz",
                             transform=transforms.ToTensor())
    data_test = DealDataSet('data/', "t10k-images-idx3-ubyte.gz", "t10k-labels-idx1-ubyte.gz",
                            transform=transforms.ToTensor())
